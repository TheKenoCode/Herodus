...
const Hero: React.FC = () => {
  return (
    <div>
      ...
      <main className="relative h-screen pt-20 bg-center bg-no-repeat bg-cover md:pt-40 lg:pt-40 xl:pt-20 backdrop-brightness-75 border-secondary">
        <div className="container relative flex flex-col items-center justify-center mx-auto text-center pt-60 xl:flex-row">
          {/* Text Section */}
          <div className="relative z-20 w-full pt-10 font-bold xl:pl-20 xl:text-start lg:pt-0">
            <Image
              alt="logo"
              src={logo}
          ...
          {/* Image Section */}
          <div className="absolute w-screen h-screen xl:pt-20">
            <HeroStatue />
          </div>
        </div>
      </main>
